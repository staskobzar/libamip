/* Generated by re2c 0.16 on Sat Feb 25 20:13:47 2017 */
#line 1 "parse_prompt.re"
/**
...
yy3:
	++cur;
yy4:
#line 63 "parse_prompt.re"
	{ return RV_FAIL; }
#line 74 "parse_prompt.c"
yy5:
	yych = *(packet = ++cur);
	switch (yych) {
	case 's':	goto yy6;
...
#line 63 "parse_prompt.re"
	{ return RV_FAIL; }
#line 229 "parse_prompt.c"
yy33:
	++cur;
#line 69 "parse_prompt.re"
	{ goto yyc_minor; }
#line 234 "parse_prompt.c"
yy35:
	++cur;
#line 68 "parse_prompt.re"
	{ ver->major = ver->major * 10 + (yych - '0'); goto yyc_major; }
#line 239 "parse_prompt.c"
/* *********************************** */
yyc_minor:
	yych = *cur;
	switch (yych) {
...
yy42:
	++cur;
#line 72 "parse_prompt.re"
	{ goto yyc_patch; }
#line 274 "parse_prompt.c"
yy44:
	++cur;
#line 71 "parse_prompt.re"
	{ ver->minor = ver->minor * 10 + (yych - '0'); goto yyc_minor; }
#line 279 "parse_prompt.c"
yy46:
	++cur;
#line 66 "parse_prompt.re"
	{ goto done; }
#line 284 "parse_prompt.c"
/* *********************************** */
yyc_patch:
	yych = *cur;
	switch (yych) {
...
yy53:
	++cur;
#line 74 "parse_prompt.re"
	{ ver->patch = ver->patch * 10 + (yych - '0'); goto yyc_patch; }
#line 318 "parse_prompt.c"
yy55:
	++cur;
#line 66 "parse_prompt.re"
	{ goto done; }
#line 323 "parse_prompt.c"
}
#line 75 "parse_prompt.re"
