/* Generated by re2c 0.16 on Fri Feb 17 18:09:43 2017 */
...
yy3:
	++cur;
yy4:
#line 62 "parse_prompt.re"
	{ return RV_FAIL; }
#line 73 "parse_prompt.c"
yy5:
	yych = *(packet = ++cur);
	switch (yych) {
	case 's':	goto yy6;
...
#line 62 "parse_prompt.re"
	{ return RV_FAIL; }
#line 228 "parse_prompt.c"
yy33:
	++cur;
#line 68 "parse_prompt.re"
	{ goto yyc_minor; }
#line 233 "parse_prompt.c"
yy35:
	++cur;
#line 67 "parse_prompt.re"
	{ ver->major = ver->major * 10 + (yych - '0'); goto yyc_major; }
#line 238 "parse_prompt.c"
/* *********************************** */
yyc_minor:
	yych = *cur;
	switch (yych) {
...
#line 71 "parse_prompt.re"
	{ goto yyc_patch; }
#line 273 "parse_prompt.c"
yy44:
	++cur;
#line 70 "parse_prompt.re"
	{ ver->minor = ver->minor * 10 + (yych - '0'); goto yyc_minor; }
#line 278 "parse_prompt.c"
yy46:
	++cur;
#line 65 "parse_prompt.re"
	{ goto done; }
#line 283 "parse_prompt.c"
/* *********************************** */
yyc_patch:
	yych = *cur;
	switch (yych) {
...
yy53:
	++cur;
#line 73 "parse_prompt.re"
	{ ver->patch = ver->patch * 10 + (yych - '0'); goto yyc_patch; }
#line 317 "parse_prompt.c"
yy55:
	++cur;
#line 65 "parse_prompt.re"
	{ goto done; }
#line 322 "parse_prompt.c"
}
